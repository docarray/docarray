...
declare -a mixins=( $(find tests -name "test_*.py" | grep -v 'path/to/paddle/test') )
...
declare -a array5=( $(ls -d tests/unit/array/*/ | grep -v '__pycache__' | grep -v 'mixins' | grep -v 'path/to/paddle/test') )
