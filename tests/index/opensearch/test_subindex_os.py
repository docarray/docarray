...
from tests.index.opensearch.fixture import auth, start_storage  # noqa: F401
...
@pytest.fixture
def index():
    index = OpenSearchDocIndex[MyDoc](index_name='idx', auth=auth)
    my_docs = [
        MyDoc(
            id=f'{i}',
            docs=DocList[SimpleDoc](
...
def test_subindex_contain(index, auth):
    ...
    # Empty index
    empty_index = OpenSearchDocIndex[MyDoc](auth=auth)
