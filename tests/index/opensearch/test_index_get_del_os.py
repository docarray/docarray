...
def test_index_simple_schema(
    ten_simple_docs, use_docarray, tmp_index_name, auth  # noqa: F811
):
...
def test_index_flat_schema(
    ten_flat_docs, use_docarray, tmp_index_name, auth
):  # noqa: F811
    index = OpenSearchDocIndex[FlatDoc](index_name=tmp_index_name, auth=auth)
    if use_docarray:
...
def test_index_nested_schema(
    ten_nested_docs, use_docarray, tmp_index_name, auth  # noqa: F811
):
    index = OpenSearchDocIndex[NestedDoc](index_name=tmp_index_name, auth=auth)
    if use_docarray:
...
def test_index_deep_nested_schema(
    ten_deep_nested_docs, use_docarray, tmp_index_name, auth  # noqa: F811
):
...
def test_get_key_error(ten_simple_docs, tmp_index_name, auth):  # noqa: F811
    index = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name, auth=auth)
    index.index(ten_simple_docs)
...
def test_persisting(ten_simple_docs, tmp_index_name, auth):  # noqa: F811
    index = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name, auth=auth)
    index.index(ten_simple_docs)

    index2 = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name, auth=auth)
    assert index2.num_docs() == 10


def test_del_single(ten_simple_docs, tmp_index_name, auth):  # noqa: F811
    index = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name, auth=auth)
    index.index(ten_simple_docs)
    # delete once
    assert index.num_docs() == 10
...
def test_del_multiple(ten_simple_docs, tmp_index_name, auth):  # noqa: F811
...
def test_del_key_error(ten_simple_docs, tmp_index_name, auth):  # noqa: F811
    index = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name, auth=auth)
    index.index(ten_simple_docs)
