...
@pytest.mark.parametrize(
    ...
    [
        ...
        (DocumentArrayPqlite, lambda: AnnliteConfig(n_dim=10)),
...
@pytest.mark.parametrize(
    ...
    [
        (DocumentArrayInMemory, lambda: None),
        (DocumentArraySqlite, lambda: None),
        (DocumentArrayPqlite, lambda: AnnliteConfig(n_dim=256)),
...
@pytest.mark.parametrize(
    ...
    [
        (DocumentArrayInMemory, lambda: None),
        (DocumentArraySqlite, lambda: None),
        (DocumentArrayPqlite, lambda: AnnliteConfig(n_dim=3)),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (DocumentArrayPqlite, AnnliteConfig(n_dim=3)),
