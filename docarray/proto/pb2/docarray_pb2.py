...
_DOCDICTPROTO = DESCRIPTOR.message_types_by_name['DocDictProto']
_DOCDICTPROTO_DOCSENTRY = _DOCDICTPROTO.nested_types_by_name['DocsEntry']
...
DocDictProto = _reflection.GeneratedProtocolMessageType(
    'DocDictProto',
    (_message.Message,),
    {
        'DocsEntry': _reflection.GeneratedProtocolMessageType(
            'DocsEntry',
            (_message.Message,),
            {
                'DESCRIPTOR': _DOCDICTPROTO_DOCSENTRY,
                '__module__': 'docarray_pb2'
                # @@protoc_insertion_point(class_scope:docarray.DocDictProto.DocsEntry)
            },
        ),
        'DESCRIPTOR': _DOCDICTPROTO,
        '__module__': 'docarray_pb2'
        # @@protoc_insertion_point(class_scope:docarray.DocDictProto)
    },
)
_sym_db.RegisterMessage(DocDictProto)
_sym_db.RegisterMessage(DocDictProto.DocsEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DOCDICTPROTO_DOCSENTRY._options = None
    _DOCDICTPROTO_DOCSENTRY._serialized_options = b'8\001'
    ...
    _NODEPROTO._serialized_end = 861
    _DOCPROTO._serialized_start = 863
    _DOCPROTO._serialized_end = 983
    _DOCPROTO_DATAENTRY._serialized_start = 919
    _DOCPROTO_DATAENTRY._serialized_end = 983
    _DICTOFANYPROTO._serialized_start = 986
    _DICTOFANYPROTO._serialized_end = 1118
    _DICTOFANYPROTO_DATAENTRY._serialized_start = 919
    _DICTOFANYPROTO_DATAENTRY._serialized_end = 983
    _LISTOFANYPROTO._serialized_start = 1120
    _LISTOFANYPROTO._serialized_end = 1171
    _DOCLISTPROTO._serialized_start = 1173
    _DOCLISTPROTO._serialized_end = 1221
    _LISTOFDOCARRAYPROTO._serialized_start = 1223
    _LISTOFDOCARRAYPROTO._serialized_end = 1282
    _DOCVECPROTO._serialized_start = 1285
    _DOCVECPROTO._serialized_end = 1868
    _DOCVECPROTO_TENSORCOLUMNSENTRY._serialized_start = 1555
    _DOCVECPROTO_TENSORCOLUMNSENTRY._serialized_end = 1631
    _DOCVECPROTO_DOCCOLUMNSENTRY._serialized_start = 1633
    _DOCVECPROTO_DOCCOLUMNSENTRY._serialized_end = 1705
    _DOCVECPROTO_DOCSVECCOLUMNSENTRY._serialized_start = 1707
    _DOCVECPROTO_DOCSVECCOLUMNSENTRY._serialized_end = 1791
    _DOCVECPROTO_ANYCOLUMNSENTRY._serialized_start = 1793
    _DOCVECPROTO_ANYCOLUMNSENTRY._serialized_end = 1868
    _DOCDICTPROTO._serialized_start = 1870
    _DOCDICTPROTO._serialized_end = 1997
    _DOCDICTPROTO_DOCSENTRY._serialized_start = 1934
    _DOCDICTPROTO_DOCSENTRY._serialized_end = 1997
