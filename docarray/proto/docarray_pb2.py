...
_DOCUMENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='_metadata', full_name='docarray.DocumentProto._metadata', index=19,
...
_DOCUMENTPROTO.fields_by_name['_metadata'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
