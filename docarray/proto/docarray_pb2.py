...
_DOCUMENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='blob', full_name='docarray.DocumentProto.blob', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='docarray.DocumentProto.tensor', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='meta_tags', full_name='docarray.DocumentProto.meta_tags', index=19,
...
_DOCUMENTPROTO.fields_by_name['tensor'].message_type = _NDARRAYPROTO
...
_DOCUMENTPROTO.fields_by_name['meta_tags'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
...
_DOCUMENTPROTO.oneofs_by_name['content'].fields.append(
  _DOCUMENTPROTO.fields_by_name['tensor'])
_DOCUMENTPROTO.fields_by_name['tensor'].containing_oneof = _DOCUMENTPROTO.oneofs_by_name['content']
_DOCUMENTPROTO.oneofs_by_name['content'].fields.append(
